...
const CROSS_ROLES = [
  ...
  { id:'children', label:'ДЕТИ',     answersFor:'будущее', gives:'учёбу · память · родню', pos:'e' },
  { id:'mother',   label:'МАТЬ',     answersFor:'детей',   gives:'тепло · преемство · род', pos:'s' },
...
const CROSS_BEFORE = { father:'государством', society:'детьми', children:'матерью', mother:'отцом' };
      ...
      <div className="rc-grid">
        {CROSS_ROLES.map(r => (
          <article
            ...
            <div className="rc-card-gives">{r.gives}</div>
          </article>
        ))}
