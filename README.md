...
|---|---|---|
| **1** | https://avvacumrechevoi.github.io/yasna3/1/ | основной сайт (по умолчанию, корень редиректит сюда) |
| **2** | https://avvacumrechevoi.github.io/yasna3/2/ | новый визуал (анимации, ясень, грамота, кольцо направлений) |

Версии живут в папках `1/` и `2/` и дорабатываются независимо: правки в `1/`
не задевают `2/` и наоборот. У версии 2 свои копии картинок (`2/src/img/`);
**общие только внутренние страницы** — заявка и страницы направлений ведут в
`1/pages/`, поэтому форму и страницы правим в одном месте, а обе главные их видят.

Чтобы версия 2 стала основной — поменять редирект в корневом `index.html` с
`./1/index.html` на `./2/index.html` (три места: canonical, meta refresh, script).
Откат — тег `version-1` (`git checkout version-1`).
